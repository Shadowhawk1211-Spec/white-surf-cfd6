...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/white-surf-cfd6#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/white-surf-cfd6
```

A live public deployment of this template is available at [https://white-surf-cfd6.templates.workers.dev](https://white-surf-cfd6.templates.workers.dev)
